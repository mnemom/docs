...
"Verified" has strong connotations in security and compliance contexts. You may incorrectly assume that AAP verification provides guarantees similar to cryptographic verification or compliance certification.
...
- Market differentiation (you can compare alignment postures)
...
**Why it's harmful**: Creates false confidence. You may trust agents more than warranted based on AAP compliance.
...
**Markets can price observed behavior**: You can choose agents based on their declared values and logged behavior, even without guarantees.
