...
An Alignment Card declares what your agent is, what values it holds, and what it will and won't do autonomously. This is the unified card shape (SDK v2.0.0) -- if you have a card from before mid-2026, see the [migration note](/protocols/aap/specification#4-10-migrating-from-the-legacy-0-5-0-card-shape) in the specification.
