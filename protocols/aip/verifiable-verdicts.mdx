...
Proving is asynchronous. The checkpoint verdict is returned immediately; the proof is generated in the background and attached to the certificate when complete. This means the ZK proof never adds latency to the critical path of integrity analysis.
