...
- Teaching errors: claiming into an org you're not in returns `403 not_a_member` with `details.claimable_orgs` (`{org_id, slug, name}`). Discover your orgs with `GET /v1/orgs` / `GET /v1/me/context` / `mnemom org list`.
