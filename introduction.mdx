...
<CardGroup cols={2}>
  ...
  <Card title="Policy Engine" icon="shield-halved" href="/concepts/policy-engine">
    Governance-as-code. Define which tools map to card capabilities, what's forbidden, and how unmapped tools are handled — with CI/CD, gateway, and observer evaluation.
  </Card>
