...
<CardGroup cols={2}>
  ...
  <Card title="Test with mnemom policy" icon="flask-vial">
    Use `mnemom policy test` to catch card gaps before they become violations. Run this in CI after any card or tool configuration change.
  </Card>
</CardGroup>
