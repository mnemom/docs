...
<Note>
Endpoint updated for historical accuracy. The original `PATCH /v1/agents/{id}/card` this page was written against was replaced by `PUT /v1/agents/{id}/alignment-card` in the 2026-04-15 unified-cards consolidation. If you're following this guide end-to-end today, use the unified alignment-card endpoint and the body shape shown below.
</Note>
