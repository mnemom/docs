...
- **Signed [advisories](/concepts/advisories)** — per-incident published JSON documents with a `synthetic` boolean, available via `GET /v1/trust/advisories`. For SOC 2 / EU AI Act / ISO 42001 evidence flows, the advisory list is the authoritative cross-tenant incident record.
