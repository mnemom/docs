...
description: "Import tool definitions in bulk from an OpenAPI 3.0+ spec or a connector YAML manifest. LLM-inferred class+domain, preview-only with operator confirmation."
