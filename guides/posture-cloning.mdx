...
Cloning a posture from a different org is **not** supported by default. The clone API requires the caller to be an org admin of the target org **and** at least a member of the source org.
