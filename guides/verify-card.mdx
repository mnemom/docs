...
```bash
mnemom verify-card smolt-e2ca60ef --api https://mnemom-api.internal.acme.example
```

The default is `https://api.mnemom.ai`. Use the `--api` flag to point at a [self-hosted](/quickstart/self-hosted) Mnemom instance instead.
