...
In GitHub, navigate to Settings > Secrets and variables > Actions, then add `MNEMOM_API_KEY` with your API key. In GitLab, navigate to Settings > CI/CD > Variables and add it there with the "Masked" option enabled.
