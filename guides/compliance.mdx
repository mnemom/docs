...
| HIPAA | **Supported** | CBD DLP is extended to the 18 PHI identifiers; PHI is tokenized before any LLM-assisted analysis; BAA available on Enterprise engagements. See caveats below. | [Safe House](/concepts/safe-house) |
...
| SEC / FINRA (investment-advice guardrails) | **Partial** | CBD `RegComplianceChecker` flags investment-advice output on Sovereign / Regulated tiers. Not a substitute for a registered entity's own supervisory program. | [Safe House](/concepts/safe-house) |
