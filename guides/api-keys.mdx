...
| `admin:platform` | `/v1/admin/*` Mnemom-staff platform operations across tenants. Re-checked per request against your current staff role. | Mnemom-staff users only |
