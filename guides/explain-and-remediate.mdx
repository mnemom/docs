...
Two paths forward: edit the forbidden list (if the rule was over-broad), or grant a documented [exemption](/api-reference/endpoint/post-exemptions) (if the agent legitimately needs this action).
