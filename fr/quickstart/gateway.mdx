...
<Tip>
  Vous cherchez à lancer un **agent de codage gouverné** plutôt que de câbler les appels API de votre propre application ? Voir [`mnemom agent`](/gateway/agent) — installez-le une fois, exécutez `mnemom agent`, et il lance Claude Code à travers la gateway avec un agent déjà configuré pour vous.
</Tip>
...
| OpenAI | GPT-6 Astra, GPT-5.6 Sol, GPT-5.6 Terra, GPT-5.6 Luna, GPT-5, GPT-5 Codex, o3, o3-mini | Non disponible via la gateway pour l'instant | `Authorization: Bearer` |
