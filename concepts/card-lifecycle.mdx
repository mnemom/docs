...
<Steps>
  ...
  <Step title="Determine cause">
    You review the violation. The key question: **was the card missing a capability, or did the agent genuinely misbehave?**
...
<Warning>
  The compliance export may contain sensitive operational data. Access requires authentication and is scoped to agents you own or administer. If you are an organization admin, you can export data for any agent in your organization.
</Warning>
