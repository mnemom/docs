...
|---|---|---|
| **L2 under-attack overlay (auto-elevation)** | Mechanism wired; auto-elevation composition layer ships Phase 4 (depends on the cards-phase-4 composition primitive). Manual operator override on org flag covers the interim. | Phase 4 production cutover (2026-05-29). |
