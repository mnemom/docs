...
To customize a platform default, [clone it](/cli/posture#clone) into your org and edit the clone.
...
The full compliance attestation surface (snapshots, control mapping, certified exports) is on the roadmap (post-T1-3.1); the foundation is the versioning model documented here.
...
CLI mirror in [`mnemom posture`](/cli/posture) subcommands (`update`, `revisions`, `diff`, `clone`).
