...
CLI mirror in [`mnemom posture`](/cli/posture).
...
- [Sideband detection](/guides/sideband-detection) — *(landing in Piece 4)* how-to: tune coherence/fault_line/fleet via posture
