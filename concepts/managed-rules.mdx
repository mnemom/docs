...
See [Managed rule envelope schema](/specifications/managed-rule-envelope-schema) for the wire format and [`/trust/slos`](/trust/slos) for the published SLOs on the failover behavior.
...
- [`/trust/slos`](/trust/slos) — published SLOs for propagation, freshness, failover
