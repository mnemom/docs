---
title: "AP-Traces"
description: "Structured records of agent actions — written same-turn at the integrity checkpoint and verified same-turn, then re-read longitudinally for drift and coherence analysis"
