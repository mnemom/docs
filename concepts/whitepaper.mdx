...
<Info>
For the full attestation specification, see [Integrity Certificates](/protocols/aip/certificates). For the technical paper with implementation details and benchmarks, see [Verifiable Integrity Verdicts](/whitepapers/verifiable-integrity).
</Info>
