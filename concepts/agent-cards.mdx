...
5. Applies `autonomy.forbidden_actions` as hard deny; applies `integrity_mode` to the checkpoint pipeline.
...
- The mnemom-api migration pipeline composed all existing data into unified cards during the 2026-04-15 rollout. No customer action was required.
