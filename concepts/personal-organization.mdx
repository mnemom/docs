...
The Mnemom safe house composes governance state across four scopes: **platform**, **org**, **team**, **agent**. Every agent in the system inherits from each layer; the cascade is uniform regardless of whether the user is a solo developer or a 10,000-person enterprise.
...
| Can host teams | Yes (default team only, in v1) | Yes (multiple) |
