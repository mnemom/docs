...
Cards Action sits at the editorial seam of the [agent cards](/concepts/agent-cards) flow:
...
The action targets GitHub Actions. If you'd benefit from support for another CI provider, file an issue at [`mnemom/cards-action`](https://github.com/mnemom/cards-action/issues) — it's the same underlying Mnemom API surface either way, just a different glue layer.

## Repository + Marketplace

- **GitHub:** [`mnemom/cards-action`](https://github.com/mnemom/cards-action)
- **Marketplace:** [Mnemom Cards](https://github.com/marketplace/actions/mnemom-cards)
- **License:** MIT

## See also

- [Agent Cards](/concepts/agent-cards) — the URL surface the action reads from.
- [AI Helpers](/concepts/ai-helpers) — simulate / explain / scaffold.
