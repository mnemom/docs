...
| **`403 Forbidden`** | Authenticated, not authorized for the requested resource or action. | No. |
...
| `invalid_hash_proof` | The `hash_proof` supplied to prove agent-key possession (claim, link, rekey) doesn't match. |
