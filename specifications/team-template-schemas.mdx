...
A team-scope alignment template is a **partial** [Alignment Card](/specifications/alignment-card-schema). The composer reads the same field paths the agent card reads, but a template legitimately omits fields that are author-specific (`agent_id`, `card_version`, etc. — see allow-list).
...
A team-scope protection template is a **partial** [Protection Card](/specifications/protection-card-schema). Fields:
...
- [Alignment Card Schema](/specifications/alignment-card-schema) — full agent-card schema (template is a partial form)
- [Protection Card Schema](/specifications/protection-card-schema)
