...
<Info>
Custom conscience values require the `custom_conscience_values` entitlement, enabled on enterprise agreements. Contact [sales](https://mnemom.ai/pricing) to enable this feature.
</Info>
