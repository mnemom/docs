...
The pre-UC whole-card `org_card_exempt` flag was replaced in UC-4 (2026-04-15) by **section-specific exemptions** that target one field of the org card at a time, with audit metadata. Manage them via:
