...
On the hosted gateway, Safe House needs no separate setup or API keys from you — L2 analysis runs through the same Anthropic API access the gateway already uses.
