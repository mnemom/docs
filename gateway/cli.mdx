...
<Note>
Looking to launch a **governed coding agent**? See [`mnemom code`](/gateway/code)
— it launches Claude Code through the gateway with good defaults, saved config,
and an agent set up for you.
</Note>
