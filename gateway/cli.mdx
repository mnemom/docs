...
launcher, and the fleet verbs `list`, `claim`, `move`, `sessions`, and `show`.
...
saved settings, contracts, guardrails, and the context-folding and implicit
goal-mode toggles are documented on their own page:
...
newest first — the last 20 unless `--all`.
...
```
2026-02-17 14:32:01  CLEAR      api_call    Claude Sonnet 5    "Search for documents"
2026-02-17 14:31:45  CLEAR      api_call    Claude Sonnet 5    "Summarize results"
2026-02-17 14:31:12  REVIEW     api_call    GPT-5              "Execute trade"
  └─ concern: autonomy_violation (HIGH) — action exceeds bounded_actions
2026-02-17 14:30:58  CLEAR      api_call    Claude Sonnet 5    "Draft email"
```
