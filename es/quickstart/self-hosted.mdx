...
Ejecuta Mnemom Gateway en tu propia infraestructura para un control completo de la residencia de datos. El contenido de los prompts y respuestas permanece dentro de tu infraestructura — consulta [Residencia de datos](#residencia-de-datos) para ver los límites exactos del tráfico. La pasarela auto-alojada es un adaptador Node.js que ejecuta el mismo código que el servicio gestionado de Cloudflare Workers — comportamiento idéntico, tu infraestructura.
...
El contenido de los prompts y respuestas nunca sale de tu infraestructura. El siguiente tráfico sí cruza los límites de la red:
