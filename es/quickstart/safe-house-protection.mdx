...
A partir de aquí, una solicitud que devuelve resultados de herramientas al modelo se filtra **de nuevo dentro de esa misma solicitud** — una vez por cada resultado de herramienta, en su propia superficie, antes de que el cuerpo se reenvíe al proveedor. En los modos `nudge` y `enforce`, la pasarela toma los tres primeros resultados de herramienta que transporta el cuerpo. Es una comprobación de puerta de entrada; nada espera al siguiente turno del agente.
