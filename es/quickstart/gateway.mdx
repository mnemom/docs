...
<Steps>
  ...
  <Step title="Autenticarse">
    ...
    Esto abre un flujo de inicio de sesión en el navegador y guarda tu token de autenticación en `~/.mnemom/auth.json`.
...
| OpenAI | GPT-6 Astra, GPT-5.6 Sol, GPT-5.6 Terra, GPT-5.6 Luna, GPT-5, GPT-5 Codex, o3, o3-mini | Mediante resúmenes de razonamiento (confianza reducida) | `Authorization: Bearer` |
...
|-----------------|-------------|--------|
| Modelos de razonamiento de Anthropic (Opus, Sonnet) | Completo | Bloques de razonamiento analizados directamente |
| Serie OpenAI GPT-5 Thinking | Parcial | Resúmenes de razonamiento (confianza reducida) |
...
| Serie OpenAI o (o3, o3-mini) | Parcial | Solo resúmenes de razonamiento — confianza reducida |
