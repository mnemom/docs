...
| OpenAI | GPT-5, GPT-5 Codex, o3, o3-mini, GPT-5.6 Sol, GPT-5.6 Terra, GPT-5.6 Luna | Via reasoning summaries (reduced confidence) | `Authorization: Bearer` |
| Gemini | Gemini 2.5 Pro, Gemini 2.5 Flash, Gemini 3.8 Flash, Gemini 3.5 Flash, Gemini 3.5 Flash-Lite | Full (thought parts analyzed directly) | `x-goog-api-key` |
