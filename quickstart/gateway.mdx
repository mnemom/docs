...
<Steps>
  ...
  <Step title="Initialize">
    Run `mnemom init` to configure your environment. The CLI detects your configured AI provider API keys (Anthropic, OpenAI, Gemini) and sets up routing through the Mnemom gateway.
  ...
  <Step title="View traces">
    ...
    Use `mnemom logs -l 20` to show more entries.
  </Step>
