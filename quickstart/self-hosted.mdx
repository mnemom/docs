...
<Steps>
  ...
  <Step title="Connect an agent">
    ...
    mnemom init --gateway=http://localhost:8787
    ```
...
<Steps>
  <Step title="Add the Helm chart">
    ```bash
    cd smoltbot/deploy/helm  # navigate to the helm chart
    ```
  </Step>
