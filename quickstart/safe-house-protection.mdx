...
This quickstart walks you through enabling Safe House on an existing agent, observing real threat detections, switching to enforce mode, and managing quarantined messages. You will need a smoltbot agent already registered — if you do not have one, see [Smoltbot Overview](/smoltbot/overview) first.
