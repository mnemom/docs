...
<Columns cols={3}>
  ...
  <Card title="isittrustready scan" icon="certificate">
    `https://api.isittrustready.ai/mcp`

    One tool — `scan_trust` — grades any site's agent-readiness (verifiable identity, alignment, attestation, accountability, delegation+auth) and returns a signed, verifiable result. No authentication required.
  </Card>
</Columns>
